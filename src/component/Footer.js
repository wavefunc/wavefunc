   ...
   return (
      <div id="footer" className='d-flex px-3 justify-content-between align-items-center'>
         <div className='d-inline-flex h-75 align-items-center'>
            ...
            <Image className='mx-2' height="75%" src="/assets/webtech/html5.svg" />
            <Image className='mx-2' height="75%" src="/assets/webtech/css3.svg" />
            <Image className='mx-2' height="75%" src="/assets/webtech/javascript.svg" />
            <Image className='mx-2' height="75%" src="/assets/webtech/react.png" />
            <Image className='mx-2' height="75%" src="/assets/webtech/gsap.png" />
         </div>
         <div className='d-inline-flex h-75 align-items-center'>
